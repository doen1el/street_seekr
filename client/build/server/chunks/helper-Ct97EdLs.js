...
import { d as stringify, p as parse, l as app } from './app-CVlUDIrM.js';
import { l as get, w as writable, o as derived, p as readonly } from './utils-CnqwCm3b.js';
import { F as noop, G as current_component, I as getContext, E as DEV } from './index-DOTLEX8b.js';
import { a as applyAction, i as invalidateAll } from './client-Wqcy-_Io.js';
...
const en_name_needs_at_least_1_character = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Name needs to be at least 1 character long.`;
  }
);
const de_name_needs_at_least_1_character = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Der Name muss mindestens 1 Zeichen lang sein.`;
  }
);
const name_needs_at_least_1_character = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("name_needs_at_least_1_character", locale);
  if (locale === "en") return en_name_needs_at_least_1_character();
  return de_name_needs_at_least_1_character();
};
...
async function getOrCreatePlayer(locals, cookies, username) {
...
export { superForm as a, createEventDispatcher as c, getOrCreatePlayer as g, name_needs_at_least_1_character as n, onDestroy as o, superValidate as s, tick as t, zod as z };
//# sourceMappingURL=helper-Ct97EdLs.js.map
